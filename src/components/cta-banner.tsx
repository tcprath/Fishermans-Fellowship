    ...
    <section className="relative overflow-hidden py-20">
      ...
      <div className="relative z-10 max-w-[var(--max-w-content,1140px)] mx-auto px-5">
        <div className="grid md:grid-cols-2 gap-0 divide-y md:divide-y-0 md:divide-x divide-[rgba(255,255,255,0.1)]">
          ...
          {/* ── Subscribe ── */}
          <div className="pb-12 md:pb-0 md:pr-14">
            ...
            <div className="bg-[rgba(255,255,255,0.12)] backdrop-blur-sm rounded-[16px] p-6 max-w-sm border border-[rgba(255,255,255,0.15)]">
              <SubscribeForm dark />
            </div>
          </div>

          {/* ── Donate ── */}
          <div className="pt-12 md:pt-0 md:pl-14 flex flex-col justify-center">
            <p className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.24em] text-[var(--ff-gold)] mb-3">
              <Sparkle size={10} className="text-[var(--ff-gold)]" />
              Partner with Us
            </p>
